...
from src2_object_detection.srv import approach_base_station, approach_base_stationResponse
...
class ApproachBaseStationService:
    ...
    def __init__(self):
        ...
        s = rospy.Service('approach_base_station', approach_base_station, self.approach_base_station_handle)
        rospy.spin()
